...
function Editor(_ref) {
  ...
  // ============================================================================
  var editorRef = React.useRef(null); // Reference to the main contentEditable div
  var editorContainerRef = React.useRef(null); // Reference to the editor container wrapper
  ...
  var _useState11 = React.useState(value || ""),
  ...
  var normalizedPlugins = React.useMemo(function () {
  ...
  var _useState13 = React.useState("en"),
  ...
  // ============================================================================
  var savedSelectionRef = React.useRef(null); // Saved selection before opening dialogs
  var savedTableSelectionRef = React.useRef(null); // Saved selection before table insertion
  var savedEmojiSelectionRef = React.useRef(null); // Saved selection before emoji picker
  var isSettingContent = React.useRef(false); // Flag to prevent onChange during programmatic content updates
  var lastValueRef = React.useRef(value); // Last known value prop to detect changes
  var lastHtmlRef = React.useRef(""); // Last known HTML to prevent unnecessary onChange calls
   ...
   */
  var convertMarkdownHeadingsInHTML = React.useCallback(function (html) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    if (button.cmd === "insertTableGrid") {
      ...
      }, Icon && /*#__PURE__*/React__default["default"].createElement(Icon, null)), showTableGrid && /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    if (button.cmd === "insertEmoji") {
      return /*#__PURE__*/React__default["default"].createElement("div", {
        ...
        title: button.tooltip
      }, Icon && /*#__PURE__*/React__default["default"].createElement(Icon, null)), showEmojiPicker && /*#__PURE__*/React__default["default"].createElement("div", {
  ...
  }, isPreview ? /*#__PURE__*/React__default["default"].createElement(FaEdit, null) : /*#__PURE__*/React__default["default"].createElement(FaEye, null)))), (normalizedPlugins === null || normalizedPlugins === void 0 ? void 0 : normalizedPlugins.length) > 0 && /*#__PURE__*/React__default["default"].createElement("div", {
